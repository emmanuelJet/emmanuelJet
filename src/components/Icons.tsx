...
export const LinkedInIcon: React.FC<React.SVGProps<SVGSVGElement>> = () => (
  <svg className='w-6 h-6 fill-current text-[var(--color-text)] hover:text-[var(--color-primary)] transition-colors' fill='currentColor' viewBox='0 0 24 24'>
    <path d='M4.98 3.5C4.98 4.88 3.88 6 2.5 6S0 4.88 0 3.5 1.12 1 2.5 1 4.98 2.12 4.98 3.5zM0 24h5V7H0v17zM8 24h5V14c0-2.21 3-2.4 3 0v10h5V13c0-6-7-5.78-8-2.82V7H8v17z'/>
  </svg>
);

export const XIcon: React.FC<React.SVGProps<SVGSVGElement>> = () => (
  <svg className='w-6 h-6 fill-current text-[var(--color-text)] hover:text-[var(--color-primary)] transition-colors' fill='currentColor' viewBox='0 0 512 512'>
